...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class UpdateMailSettingsConsumer : IConsumer<IUpdateMailSettings>
    {
        ...
        public UpdateMailSettingsConsumer(
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<IUpdateMailSettings> context)
        {
            ...
            var company = await _companyRepository.UpdateMailSettings(context.Message);
