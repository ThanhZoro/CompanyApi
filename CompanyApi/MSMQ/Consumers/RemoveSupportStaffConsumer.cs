...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class RemoveSupportStaffConsumer : IConsumer<IRemoveSupportStaff>
    {
        ...
        public RemoveSupportStaffConsumer(
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<IRemoveSupportStaff> context)
        {
            ...
            var lead = await _leadRepository.RemoveSupportStaff(context.Message);
