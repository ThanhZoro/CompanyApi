...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class CreateTeamConsumer : IConsumer<ICreateTeam>
    {
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<ICreateTeam> context)
        {
            ...
            var team = await _teamRepository.Create(context.Message);
