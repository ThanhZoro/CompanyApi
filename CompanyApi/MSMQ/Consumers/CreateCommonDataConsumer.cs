...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class CreateCommonDataConsumer : IConsumer<ICreateCommonData>
    {
        ...
        public CreateCommonDataConsumer(
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<ICreateCommonData> context)
        {
            ...
            var commonData = await _commonDataRepository.Create(context.Message);
