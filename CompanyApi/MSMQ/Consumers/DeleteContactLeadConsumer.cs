...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class DeleteContactLeadConsumer : IConsumer<IDeleteContactLead>
    {
        ...
        public DeleteContactLeadConsumer(
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<IDeleteContactLead> context)
        {
            ...
            var contactLead = await _contactLeadRepository.Delete(context.Message);
