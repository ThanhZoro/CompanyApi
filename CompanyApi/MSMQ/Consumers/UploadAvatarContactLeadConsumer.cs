...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class UploadAvatarContactLeadConsumer : IConsumer<IUploadAvatarContactLead>
    {
        ...
        public UploadAvatarContactLeadConsumer(
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<IUploadAvatarContactLead> context)
        {
            ...
            var contactLead = await _contactLeadRepository.Upload(context.Message);
