...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class UpdateCompanyConsumer : IConsumer<IUpdateCompany>
    {
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<IUpdateCompany> context)
        {
            ...
            var company = await _companyRepository.UpdateInfo(context.Message);
