...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class UploadLogoCompanyConsumer : IConsumer<IUploadLogoCompany>
    {
        ...
        public UploadLogoCompanyConsumer(
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<IUploadLogoCompany> context)
        {
            ...
            var company = await _companyRepository.UpdateLogo(context.Message);
