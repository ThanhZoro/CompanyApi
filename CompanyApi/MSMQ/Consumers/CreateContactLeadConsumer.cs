...
namespace Consumers
{
    ...
    /// 
    /// </summary>
    public class CreateContactLeadConsumer : IConsumer<ICreateContactLead>
    {
        ...
        public CreateContactLeadConsumer(
        ...
        /// <returns></returns>
        public async Task Consume(ConsumeContext<ICreateContactLead> context)
        {
            ...
            var contactLead = await _contactLeadRepository.Create(context.Message);
